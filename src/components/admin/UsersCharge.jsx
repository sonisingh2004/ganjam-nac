    ...
    <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-7 hover:shadow-2xl transition-all duration-500 border border-gray-100 group relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center p-5 bg-gradient-to-br from-green-50 to-lime-50 rounded-xl hover:shadow-md transition-all duration-300 border border-green-100">
            <div className="flex items-center justify-center mb-3">
              <span className="w-3 h-3 rounded-full bg-green-500 mr-2 shadow-lg shadow-green-500/50"></span>
              <span className="text-sm text-gray-600 font-semibold">Till Month</span>
            </div>
            <div className="text-3xl font-extrabold bg-gradient-to-r from-green-600 to-lime-600 bg-clip-text text-transparent">
              ₹{data?.tillMonth || 0}
            </div>
          </div>
        </div>
